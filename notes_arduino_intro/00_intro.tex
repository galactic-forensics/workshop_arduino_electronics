...
\paragraph{\href{https://en.wikipedia.org/wiki/Electric_power}{Electric power}} If a current flows through a resistor, electrical energy is transferred. The energy per time that is used in this resistor is the electric power $P$, which can be calculated as
\begin{equation}
    P = U I.
\end{equation}
...
\infobox{Help with programming your Arduino}{To find further information on how to code an Arduino and get yourself started with \cpp, see the following linksx:
\begin{itemize}

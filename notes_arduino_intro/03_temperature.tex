...
\qbox{How would you determine the temperature? The lookup table has the most precision, however, what would you do with a resistance that is in between two values in the table? Our setup will have an actual temperature range between around 25\celsius and -20\celsius. Come up with an adequate way to determine the temperature in this range.}
